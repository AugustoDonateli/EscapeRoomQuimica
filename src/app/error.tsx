 ...
 * error occurred" e nada mais. Esta tela ao menos diz para onde ir: o
 * diagnóstico resolve o caso mais comum, que é configuração faltando.
 */
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col justify-center px-5 py-10">
      ...
      <p className="mt-2 text-mini text-tinta-2">
        Se isto acabou de ser publicado, quase sempre é configuração faltando.
      </p>
